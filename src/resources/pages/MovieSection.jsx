...
export default function MovieSection() {
     ...
     const url = `https://api.themoviedb.org/3/movie/popular?api_key=${apy_key}&language=en-US&page=12`;
          
     const [list, SetList] = useState();
     useEffect(()=> {
          axios
          .get(url)
          .then(({data}) => SetList(data.results.slice(0, 12)))
  ...
  return (
     <div className="h-[80vh] bg-black flex justify-center">
          ...
          <div className="grid grid-cols-4 gap-36 content-start">
